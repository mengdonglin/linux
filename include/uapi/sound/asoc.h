 ...
 * | struct snd_soc_tplg_hdr           |  1  |
 * +-----------------------------------+-----+
 * | struct snd_soc_tplg_dapm_pcm      |  N  |
 * +-----------------------------------+-----+
 */
struct snd_soc_tplg_pcm {
	...
	struct snd_soc_tplg_stream streams[SND_SOC_TPLG_STREAM_CONFIG_MAX]; /* for DAI link */
	__le32 num_streams;	/* number of streams */
	struct snd_soc_tplg_stream_caps caps[2]; /* playback and capture for DAI */
} __attribute__((packed));

 /*
 * Describes runtime supported configs or params of BE/CC DAI links
 *
...
struct snd_soc_tplg_link_config {
	__le32 size;		/* in bytes of this structure */
	char name[SNDRV_CTL_ELEM_ID_NAME_MAXLEN]; /* DAI link name */
	__le32 id;		/* unique ID - used to match */
	struct snd_soc_tplg_stream streams[SND_SOC_TPLG_STREAM_CONFIG_MAX]; /* supported configs */
	__le32 num_streams;	/* number of streams */
} __attribute__((packed));
#endif
