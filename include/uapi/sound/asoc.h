 ...
 */
#define SND_SOC_TPLG_HW_CONFIG_MAX	16
...
#define SND_SOC_TPLG_TYPE_LINK_HW_CONFIG	13
#define SND_SOC_TPLG_TYPE_MAX		SND_SOC_TPLG_TYPE_LINK_HW_CONFIG
...
#define SND_SOC_TPLG_DAIFMT_I2S		1 /* I2S mode */
#define SND_SOC_TPLG_DAIFMT_RIGHT_J	2 /* Right Justified mode */
#define SND_SOC_TPLG_DAIFMT_LEFT_J	3 /* Left Justified mode */
#define SND_SOC_TPLG_DAIFMT_DSP_A	4 /* L data MSB after FRM LRC */
#define SND_SOC_TPLG_DAIFMT_DSP_B	5 /* L data MSB during FRM LRC */
#define SND_SOC_TPLG_DAIFMT_AC97	6 /* AC97 */
#define SND_SOC_TPLG_DAIFMT_PDM		7 /* Pulse density modulation */

/* left and right justified also known as MSB and LSB respectively */
#define SND_SOC_TPLG_DAIFMT_MSB		SND_SOC_TPLG_DAIFMT_LEFT_J
#define SND_SOC_TPLG_DAIFMT_LSB		SND_SOC_TPLG_DAIFMT_RIGHT_J

/* maximum number of channels */
#define SND_SOC_TPLG_CHANNEL_MAX	8
...
struct snd_soc_tplg_hw_config {
	__le32 size;            /* in bytes of this structure */
	__le32 fmt;		/* SND_SOC_TPLG_DAIFMT_* */
	...
	__le32 tx_chanmap[SND_SOC_TPLG_CHANNEL_MAX]; /* array of slot number */
	__le32 rx_channels;	/* number of Rx channels */
	__le32 rx_chanmap[SND_SOC_TPLG_CHANNEL_MAX]; /* array of slot number */
} __attribute__((packed));
...
struct snd_soc_tplg_manifest {
	...
	__le32 dai_hw_cfg_elems;/* number of DAI hw config elements */
...
/*
 * Describes the BE or CC link runtime supported configs or params.See
 * snd_soc_tplg_link_hw_config for hardware configuration.
 *
...
/*
 * Describes the BE or CC link runtime supported hardware config. See
 * snd_soc_tplg_link_config for stream, SW and FW configuration.
 *
 * File block representation for BE/CC link HW config :-
 * +-------------------------------------+-----+
 * | struct snd_soc_tplg_hdr             |  1  |
 * +-------------------------------------+-----+
 * | struct snd_soc_tplg_link_hw_config  |  N  |
 * +-------------------------------------+-----+
 */
struct snd_soc_tplg_link_hw_config {
	__le32 size;            /* in bytes of this structure */
	__le32 id;              /* unique ID - used to match with DAI link */
	 __le32 num_hw_configs;     /* number of configs */
